...
class ClientConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[str] ca_certificate: The Certificate Authority (CA) certificate used to verify connections to the Talos API server.
        :param pulumi.Input[str] client_certificate: The client certificate used to authenticate to the Talos API server.
        :param pulumi.Input[str] client_key: The private key for the client certificate, used for authenticating the client to the Talos API server.
        """
...
if not MYPY:
    class ClusterMachinesArgsDict(TypedDict):
        ...
        """
        config_patches: NotRequired[pulumi.Input[str]]
        """
        ...
        """
        talos_image: NotRequired[pulumi.Input[str]]
        """
...
class ClusterMachinesArgs:
    def __init__(__self__, *,
                 ...
                 config_patches: Optional[pulumi.Input[str]] = None,
                 talos_image: Optional[pulumi.Input[str]] = None):
        """
        :param str machine_id: ID or name of the machine.
        :param 'MachineTypes' machine_type: Type of the machine.
        :param pulumi.Input[str] node_ip: The IP address of the node where configuration will be applied.
        :param pulumi.Input[str] cluster_endpoint: cluster endpoint generated
        :param pulumi.Input[str] config_patches: User-provided machine configuration to apply. 
               Must be a valid YAML string. 
               For structure, see https://www.talos.dev/latest/reference/configuration/v1alpha1/config/
        :param pulumi.Input[str] talos_image: Talos OS installation image. 
               Used in the `install` configuration and set via CLI. 
               The default is generated based on the Talos machinery version, current: ghcr.io/siderolabs/installer:v1.8.2.
        """
        ...
        if talos_image is None:
            talos_image = 'ghcr.io/siderolabs/installer:v1.8.2'
    ...
    def node_ip(self) -> pulumi.Input[str]:
        """
        The IP address of the node where configuration will be applied.
        """
    ...
    @node_ip.setter
    def node_ip(self, value: pulumi.Input[str]):
    ...
    def config_patches(self) -> Optional[pulumi.Input[str]]:
        """
        User-provided machine configuration to apply. 
        Must be a valid YAML string. 
        For structure, see https://www.talos.dev/latest/reference/configuration/v1alpha1/config/
    ...
    def config_patches(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "config_patches", value)

    @property
    @pulumi.getter(name="talosImage")
    def talos_image(self) -> Optional[pulumi.Input[str]]:
        """
        Talos OS installation image. 
        Used in the `install` configuration and set via CLI. 
        The default is generated based on the Talos machinery version, current: ghcr.io/siderolabs/installer:v1.8.2.
    ...
    @talos_image.setter
    def talos_image(self, value: Optional[pulumi.Input[str]]):
...
if not MYPY:
    class MachineInfoArgsDict(TypedDict):
        ...
        TO DO
        """
        user_config_patches: NotRequired[pulumi.Input[str]]
        """
        User-provided machine configuration to apply. 
        This can be retrieved from the cluster resource.
        """
...
class MachineInfoArgs:
    def __init__(__self__, *,
                 ...
                 talos_image: Optional[pulumi.Input[str]] = None,
                 user_config_patches: Optional[pulumi.Input[str]] = None):
        """
        :param pulumi.Input[str] configuration: Configuration settings for machines to apply. 
               This can be retrieved from the cluster resource.
        :param pulumi.Input[str] machine_id: ID or name of the machine.
        :param pulumi.Input[str] node_ip: The IP address of the node where configuration will be applied.
        :param pulumi.Input[str] cluster_endpoint: cluster endpoint applied to node
        :param pulumi.Input[str] kubernetes_version: TO DO
        :param pulumi.Input[str] talos_image: TO DO
        :param pulumi.Input[str] user_config_patches: User-provided machine configuration to apply. 
               This can be retrieved from the cluster resource.
        """
    ...
    def user_config_patches(self) -> Optional[pulumi.Input[str]]:
        """
        User-provided machine configuration to apply. 
        This can be retrieved from the cluster resource.
        """
    ...
    def user_config_patches(self, value: Optional[pulumi.Input[str]]):
