...
class ClusterArgs:
    def __init__(__self__, *,
                 ...
                 talos_version_contract: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Cluster resource.
        :param pulumi.Input[builtins.str] cluster_endpoint: Cluster endpoint, the Kubernetes API endpoint accessible by all nodes
        ...
        :param pulumi.Input[builtins.str] kubernetes_version: Kubernetes version to install. 
               Default is v1.31.0.
        :param pulumi.Input[builtins.str] talos_version_contract: Version of Talos features used for configuration generation. 
               ...
               The default value is based on gendata.VersionTag, current: v1.9.5.
        """
    ...
    @cluster_name.setter
    def cluster_name(self, value: builtins.str):
    ...
    def talos_version_contract(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def talos_version_contract(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Cluster(pulumi.ComponentResource):
    ...
    def generated_configurations(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        TO DO
        """
