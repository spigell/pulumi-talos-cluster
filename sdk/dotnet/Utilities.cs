...
namespace Pulumi.TalosCluster
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/spigell/pulumi-talos-cluster";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.TalosCluster.version.txt");
    ...
    internal sealed class TalosClusterResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public TalosClusterResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
