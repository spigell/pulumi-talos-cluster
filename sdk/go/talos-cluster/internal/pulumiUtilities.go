...
func PkgVersion() (semver.Version, error) {
	...
	re := regexp.MustCompile("^.*/pulumi-talos-cluster/sdk(/v\\d+)?")
...
func PkgResourceDefaultOpts(opts []pulumi.ResourceOption) []pulumi.ResourceOption {
	...
	defaults = append(defaults, pulumi.PluginDownloadURL("github://api.github.com/spigell/pulumi-talos-cluster"))
	version := SdkVersion
