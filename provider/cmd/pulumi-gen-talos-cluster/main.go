...
import (
	...
	"github.com/spigell/pulumi-talos-cluster/cmd/pulumi-gen-talos-cluster/resources"
...
func generateSchema() schema.PackageSpec {
	...
	return schema.PackageSpec{
		...
		Types:             resources.ClusterTypes(),
		Resources: map[string]schema.ResourceSpec{
			resources.ClusterResourceName: {
				IsComponent: true,
				ObjectTypeSpec: schema.ObjectTypeSpec{
					Description: "Initialize a new talos cluster: creates secrets and configure ",
					Properties: resources.ClusterProperties(),
				},
				InputProperties: resources.ClusterInputProperties(),
			},
		},
		Language: map[string]schema.RawMessage{
			...
			"go": rawMessage(map[string]interface{}{
				...
				"importBasePath":                 fmt.Sprintf("github.com/spigell/%s/sdk/go/change-me", provider.ProviderName),
			}),
		},
	}
}
